...
describe('req', () => {
  describe('.baseUrl', () => {
    it('should be empty for top-level route', done => {
      const app = express()
    ...
    it('should contain lower path', done => {
      const app = express()
    ...
    it('should contain full lower path', done => {
      const app = express()
    ...
    it('should travel through routers correctly', done => {
      const urls = []
      const app = express()
      const sub1 = express.Router()
      const sub2 = express.Router()
