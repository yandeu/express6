...
describe('res', () => {
  describe('.location(url)', () => {
    ...
    describe('when url is "back"', () => {
      it('should set location from "Referer" header', done => {
        const app = express()
      ...
      it('should set location from "Referrer" header', done => {
        const app = express()
      ...
      it('should prefer "Referrer" header', done => {
        const app = express()
      ...
      it('should set the header to "/" without referrer', done => {
        const app = express()
